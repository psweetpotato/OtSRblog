...
Parse.Cloud.beforeSave("emailObject", function(request, response) {
    ...
    var text = "Submission Form From http://psweetpotato.github.io/OtSRblog/\n\n" +
    ...
    Mailgun.sendEmail({
            ...
            subject: "Submission Form http://psweetpotato.github.io/OtSRblog/ from: " + request.object.get("name"),
            text: text
        }, {
